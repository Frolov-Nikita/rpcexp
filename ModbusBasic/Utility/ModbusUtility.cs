...
namespace ModbusBasic.Utility
{
    ...
    public static class ModbusUtility
    {
        ...
        public static double GetDouble_(ushort b3, ushort b2, ushort b1, ushort b0)
        {
        ...
        public static float GetSingle_(ushort highOrderValue, ushort lowOrderValue)
        {
