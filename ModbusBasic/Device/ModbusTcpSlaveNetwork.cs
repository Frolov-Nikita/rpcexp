    ...
    internal class ModbusTcpSlaveNetwork : ModbusSlaveNetwork
    {
...
#endif
        internal ModbusTcpSlaveNetwork(TcpListener tcpListener, IModbusFactory modbusFactory)
        ...
        public override async Task ListenAsync(CancellationToken cancellationToken = new CancellationToken())
        {
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                var masterConnection = new ModbusMasterTcpConnection(client, this, ModbusFactory);
