...
namespace ModbusBasic.Device
{
    ...
    internal class ModbusUdpSlaveNetwork : ModbusSlaveNetwork
    {
        ...
        public ModbusUdpSlaveNetwork(UdpClient udpClient, IModbusFactory modbusFactory)
            : base(new ModbusIpTransport(new UdpClientAdapter(udpClient), modbusFactory), modbusFactory)
        {
