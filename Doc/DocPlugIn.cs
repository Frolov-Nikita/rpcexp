...
namespace Doc
{
    ...
    [HelpFileBuilderPlugInExport("Doc", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "Doc plug-in")]
    public sealed class DocPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In DocPlugIn Execute() method");
        }
        #endregion
